...
<div class="layui-form layuimini-form">
    <form class="layui-form" action="${pageContext.request.contextPath}/updateDog" method="post">
        <div class="layui-form-item" hidden>
            <label class="layui-form-label">狗狗Id</label>
            <div class="layui-input-block">
                <input id="dogId" type="text" name="dogId" lay-verify="title" autocomplete="off" placeholder="注意狗狗Id唯一" class="layui-input">
            </div>
        </div>
